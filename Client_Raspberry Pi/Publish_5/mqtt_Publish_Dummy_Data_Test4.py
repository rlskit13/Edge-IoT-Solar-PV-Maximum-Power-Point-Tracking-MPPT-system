...
def publish_Fake_Sensor_Values_to_MQTT():
	...
	Voltage_Fake_Value = float("{0:.2f}".format(random.uniform(50, 100)))
	...
	#print ("Publishing PV 4 fake Voltage, Current, Power Value: " + str(Voltage_Fake_Value) + ", " + str(Current_Fake_Value) + ", " + str(Power) + "...")
